...
import warnings
import os
try:  # pkg_resources is deprecated; only needed by frost(), which ActiveSAM does not use.
    from pkg_resources import resource_filename
except Exception:  # keep the module importable on setuptools without pkg_resources
